...
import static twitter4j.TwitterAdsConstants.MAX_IMAGE_SIZE_FOR_TWITTER_IN_BYTES;
import static twitter4j.TwitterAdsConstants.MAX_VIDEO_SIZE_IN_BYTES;
import static twitter4j.TwitterAdsConstants.MAX_WAIT_TIME;
import static twitter4j.TwitterAdsConstants.MAX_WAIT_TIME_TRANSCODING;
import static twitter4j.TwitterAdsConstants.PARAM_COMMAND;
import static twitter4j.TwitterAdsConstants.PARAM_MEDIA_CATEGORY;
import static twitter4j.TwitterAdsConstants.PARAM_MEDIA_DATA;
import static twitter4j.TwitterAdsConstants.PARAM_MEDIA_ID;
import static twitter4j.TwitterAdsConstants.PARAM_MEDIA_TYPE;
import static twitter4j.TwitterAdsConstants.PARAM_SEGMENT_INDEX;
import static twitter4j.TwitterAdsConstants.PARAM_TOTAL_BYTES;
import static twitter4j.TwitterAdsConstants.PARAM_VIDEO_MEDIA_ID;
import static twitter4j.TwitterAdsConstants.PREFIX_ACCOUNTS_V2;
import static twitter4j.TwitterAdsConstants.PREFIX_VIDEOS;
import static twitter4j.TwitterAdsConstants.SLASH;
import static twitter4j.TwitterAdsConstants.SUCCESSFULL_CALL_BEGIN_CODE;
import static twitter4j.TwitterAdsConstants.SUCCESSFULL_CALL_END_CODE;
import static twitter4j.TwitterAdsConstants.TWO_MIB;
import static twitter4j.TwitterAdsConstants.UPLOAD_JSON;
import static twitter4j.TwitterAdsConstants.UPLOAD_MEDIA_URL;
import static twitter4j.TwitterAdsConstants.WAIT_INTERVAL;
...
import twitter4j.internal.models4j.TwitterRuntimeException;
...
*/
    ...
    private String createVideoObject(String mediaId, String accountId) throws TwitterException {
        String url = getBaseAdsAPIUrl() + PREFIX_ACCOUNTS_V2 + accountId + PREFIX_VIDEOS;
    ...
    public TwitterVideo waitForVideoProcessing(String accountId, String videoId, long maxWaitTime) throws TwitterException {
        ...
        String url = getBaseAdsAPIUrl() + PREFIX_ACCOUNTS_V2 + accountId + PREFIX_VIDEOS + SLASH + videoId;
