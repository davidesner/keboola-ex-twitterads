...
import static twitter4j.TwitterAdsConstants.GRANULARITY;
import static twitter4j.TwitterAdsConstants.PARAM_END_TIME;
import static twitter4j.TwitterAdsConstants.PARAM_ENTITY_IDS;
import static twitter4j.TwitterAdsConstants.PARAM_ENTITY_TYPE;
import static twitter4j.TwitterAdsConstants.PARAM_JOB_IDS;
import static twitter4j.TwitterAdsConstants.PARAM_METRIC_GROUPS;
import static twitter4j.TwitterAdsConstants.PARAM_PLACEMENT;
import static twitter4j.TwitterAdsConstants.PARAM_SEGMENTATION_TYPE;
import static twitter4j.TwitterAdsConstants.PARAM_START_TIME;
import static twitter4j.TwitterAdsConstants.PARAM_WITH_DELETED;
import static twitter4j.TwitterAdsConstants.V1_PREFIX_STATS_ACCOUNTS_URI;
...
import twitter4j.models.ads.TwitterEntityStatisticsMetrics;
