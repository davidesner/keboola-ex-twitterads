...
import static twitter4j.TwitterAdsConstants.AUTOMATICALLY_SELECT_BID;
import static twitter4j.TwitterAdsConstants.PARAM_ACCOUNT_ID;
import static twitter4j.TwitterAdsConstants.PARAM_ACCOUNT_MEDIA_ID;
import static twitter4j.TwitterAdsConstants.PARAM_ADVERTISER_DOMAIN;
import static twitter4j.TwitterAdsConstants.PARAM_BID_AMOUNT_LOCAL_MICRO;
import static twitter4j.TwitterAdsConstants.PARAM_BID_TYPE;
import static twitter4j.TwitterAdsConstants.PARAM_BID_UNIT;
import static twitter4j.TwitterAdsConstants.PARAM_CALL_TO_ACTION;
import static twitter4j.TwitterAdsConstants.PARAM_CALL_TO_ACTION_URL;
import static twitter4j.TwitterAdsConstants.PARAM_CAMPAIGN_ID;
import static twitter4j.TwitterAdsConstants.PARAM_CAMPAIGN_IDS;
import static twitter4j.TwitterAdsConstants.PARAM_CATEGORIES;
import static twitter4j.TwitterAdsConstants.PARAM_CHARGE_BY;
import static twitter4j.TwitterAdsConstants.PARAM_COUNT;
import static twitter4j.TwitterAdsConstants.PARAM_CURSOR;
import static twitter4j.TwitterAdsConstants.PARAM_FUNDING_INSTRUMENT_IDS;
import static twitter4j.TwitterAdsConstants.PARAM_INCLUDE_SENTIMENT;
import static twitter4j.TwitterAdsConstants.PARAM_LANDING_URL;
import static twitter4j.TwitterAdsConstants.PARAM_LINE_ITEM_ID;
import static twitter4j.TwitterAdsConstants.PARAM_LINE_ITEM_IDS;
import static twitter4j.TwitterAdsConstants.PARAM_MATCH_RELEVANT_POPULAR_QUERIES;
import static twitter4j.TwitterAdsConstants.PARAM_OBJECTIVE;
import static twitter4j.TwitterAdsConstants.PARAM_PAUSED;
import static twitter4j.TwitterAdsConstants.PARAM_PLACEMENTS;
import static twitter4j.TwitterAdsConstants.PARAM_PRIMARY_WEB_EVENT_TAG;
import static twitter4j.TwitterAdsConstants.PARAM_PRODUCT_TYPE;
import static twitter4j.TwitterAdsConstants.PARAM_PROMOTED_ACCOUNTS_IDS;
import static twitter4j.TwitterAdsConstants.PARAM_SORT_BY;
import static twitter4j.TwitterAdsConstants.PARAM_USER_ID;
import static twitter4j.TwitterAdsConstants.PARAM_WITH_DELETED;
import static twitter4j.TwitterAdsConstants.PATH_LINE_ITEMS;
import static twitter4j.TwitterAdsConstants.PATH_MEDIA_CREATIVES;
import static twitter4j.TwitterAdsConstants.PATH_PROMOTED_ACCOUNTS;
import static twitter4j.TwitterAdsConstants.PREFIX_ACCOUNTS_V2;
import static twitter4j.TwitterAdsConstants.PRE_ROLL_CALL_TO_ACTION;
...
import twitter4j.models.ads.ProductType;
